...
if(BLAS STREQUAL "Atlas" OR BLAS STREQUAL "atlas")
  ...
  list(APPEND MSHADOW_LIBRARIES ${Atlas_LIBRARIES})
...
elseif(BLAS STREQUAL "Blas" OR BLAS STREQUAL "blas")
  ...
  message("")
  list(APPEND MSHADOW_LIBRARIES ${BLAS_LIBRARIES})
  add_definitions(-DMSHADOW_USE_CBLAS=1)
  add_definitions(-DMSHADOW_USE_MKL=0)
elseif(BLAS STREQUAL "Open" OR BLAS STREQUAL "open")
  find_package(OpenBLAS REQUIRED)
  include_directories(SYSTEM ${OpenBLAS_INCLUDE_DIR})
  list(APPEND MSHADOW_LIBRARIES ${OpenBLAS_LIB})
  add_definitions(-DMSHADOW_USE_CBLAS=1)
  add_definitions(-DMSHADOW_USE_MKL=0)
elseif(BLAS STREQUAL "MKL" OR BLAS STREQUAL "mkl")
  find_package(MKL REQUIRED)
  include_directories(SYSTEM ${MKL_INCLUDE_DIR})
  list(APPEND MSHADOW_LIBRARIES ${MKL_LIBRARIES})
...
elseif(BLAS STREQUAL "apple")
  ...
  list(APPEND MSHADOW_LIBRARIES ${Accelerate_LIBRARIES})
  add_definitions(-DMSHADOW_USE_MKL=0)
  add_definitions(-DMSHADOW_USE_CBLAS=1)
endif()
